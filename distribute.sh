...
codesign -f --deep -o runtime --timestamp --entitlements "entitlements.plist" -s $codesign_id $vst3_dist_path &&
codesign -f --deep -o runtime --timestamp --entitlements "entitlements.plist" -s $codesign_id $au_dist_path &&
